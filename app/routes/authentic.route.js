...
function authentic(req,res) {
  ...
  //Validating the input entity
   var json_format = iValidator.json_schema(schema.loginSchema, authenticData, "authentic");
...
function signup(req,res) {
  ...
  //Validating the input entity
   var json_format = iValidator.json_schema(schema.signUpSchema, signUpData, "signUpData");
   if (json_format.valid == false) {
     return res.status(422).send(json_format.errorMessage);
   }
